  ...
  useEffect(() => {
    ...
    for (const a of molecule.atoms) {
      ...
      const mesh = new THREE.Mesh(
        ...
        new THREE.MeshPhysicalMaterial({ color: info.color, roughness: 0.35, metalness: 0.15, clearcoat: 0.6 })
      );
      mesh.position.set(a.x, a.y, a.z);
      group.add(mesh);
    }
    for (const b of molecule.bonds) {
      const pa = new THREE.Vector3(molecule.atoms[b.a].x, molecule.atoms[b.a].y, molecule.atoms[b.a].z);
      const pb = new THREE.Vector3(molecule.atoms[b.b].x, molecule.atoms[b.b].y, molecule.atoms[b.b].z);
    ...
    const down = (e: PointerEvent) => { dragging = true; lastX = e.clientX; lastY = e.clientY; el.style.cursor = "grabbing"; };
