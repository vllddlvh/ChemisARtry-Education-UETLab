...
const AtomViewer3D = forwardRef<AtomViewer3DHandle, Props>(function AtomViewer3D(
  ...
  useEffect(() => {
    ...
    const initTimer = setTimeout(() => {
      ...
      // Fade in after first frame is painted
      ...
      stateRef.current = { renderer, scene, camera, group, cleanup: cleanupFn };
    }, 300); // Delay 300ms to allow page transition to finish smoothly
