...
export const ELEMENTS: Record<string, { color: string; radius: number; name: string }> = {
  ...
  B:  { color: "#ffb5b5", radius: 0.40, name: "Boron" },
  ...
  Na: { color: "#ab5cf2", radius: 0.50, name: "Sodium" },
  ...
  Ar: { color: "#80d1e3", radius: 0.40, name: "Argon" },
  ...
  Ag: { color: "#c0c0c0", radius: 0.50, name: "Silver" },
  I:  { color: "#940094", radius: 0.52, name: "Iodine" },
  Au: { color: "#ffd123", radius: 0.50, name: "Gold" },
  Hg: { color: "#b8b8d0", radius: 0.50, name: "Mercury" },
};
