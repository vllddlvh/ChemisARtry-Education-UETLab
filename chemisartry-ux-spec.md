...
*Tài liệu này là spec thiết kế — không bao gồm code implementation chi tiết cho từng component. Xem `FUNCTIONAL_DOCS.md` để biết API calls, hook signatures, và data flow hiện tại.*
